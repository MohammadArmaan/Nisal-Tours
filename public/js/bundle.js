...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXJtYWFuNzc4NiIsImEiOiJjbHg0bm45amwwZWgyMmxzYXJtdTMweGloIn0.gefptdvheKWNIjeAOV1HZQ';
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // /* eslint-disable */
var stripe = Stripe('pk_test_51PSsUt2KjubrlOfSyLtJlYiDKdBWXvNEIet8WSmg6NOna8xoslYWa3pXILQY3ed1jh8zJJTWrGXkPA1T6ZPygLnn00HsyEuLlk');
...
// FOOTER 
var year = document.querySelector('.copyright__year');
...
var navTours = document.querySelector('.nav__el__tours');
...
document.querySelectorAll('.nav__el').forEach(function (el) {
...
document.querySelector('.nav__all__tours').addEventListener('click', function () {
  header.classList.remove('open');
  navTours.classList.add('hidden');
  setTimeout(function () {
    menuBtn.style.display = 'block';
